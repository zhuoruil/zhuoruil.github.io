...
csv_5sensors = "https://drive.google.com/file/d/1uPAC21hsg4gWuAv0yGgNo03cL19iHqSN/view"
csv_18sensors = "https://drive.google.com/file/d/1hwntn_e8Ytx1REYyc0c5WRWdSXFHBXNy/view"
csv_5sensors ='https://drive.google.com/uc?id=' + csv_5sensors.split('/')[-2]
csv_18sensors ='https://drive.google.com/uc?id=' + csv_18sensors.split('/')[-2]


@st.cache
def load_data18():
    df = pd.read_csv(csv_18sensors, parse_dates=['Time Point'], na_values='-')
    return df

@st.cache
def load_data5():
    df = pd.read_csv(csv_5sensors, parse_dates=['Time Point'], na_values='-')
    return df


getATF18 = load_data18()
